...
- Run `pnpm lint` in the webapp before committing
- Run `pnpm check` to verify TypeScript/Svelte types
- Run `cargo clippy` in `src-tauri/` for Rust code

## Reporting Bugs

Use the [Bug Report](https://github.com/biboshu/bibo-desktop/issues/new?template=bug_report.md) template. Include:
...
Use the [Feature Request](https://github.com/biboshu/bibo-desktop/issues/new?template=feature_request.md) template. Explain:
